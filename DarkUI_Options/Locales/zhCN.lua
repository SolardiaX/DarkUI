...
L_OPT_BAGS_ITEM_FILTER = "启用物品分类"
L_OPT_BAGS_FILTER_EQUIPMENT = "过滤装备"
L_OPT_BAGS_FILTER_CONSUMABLE = "过滤消耗品"
L_OPT_BAGS_FILTER_GOODS = "过滤商品材料"
L_OPT_BAGS_FILTER_QUEST = "过滤任务物品"
L_OPT_BAGS_FILTER_COLLECTION = "过滤收藏品"
L_OPT_BAGS_FILTER_JUNK = "过滤垃圾"
L_OPT_BAGS_FILTER_EQUIPSET = "过滤套装集合"
L_OPT_BAGS_FILTER_AOE = "过滤战团绑定装备"
L_OPT_BAGS_FILTER_DECOR = "过滤装饰品"
L_OPT_BAGS_FILTER_LEGACY = "过滤旧版本装备"
...
L_OPT_MISC_AUTOMATION_AUTO_GREED = "满级后绿色装备 Roll 点时自动选择贪婪"
L_OPT_MISC_AUTOMATION_AUTO_QUEST = "自动交接任务 (按住 SHIFT 点击 NPC 可禁用)"
L_OPT_MISC_AUTOMATION_TAB_BINDER = "PVP 模式下优化目标选择键只选中敌对玩家"
L_HEADER_ANNOUNCEMENT = "通报"
...
L_OPT_ANNOUNCEMENT_QUEST_NOTIFICATION = "任务进度通报"
