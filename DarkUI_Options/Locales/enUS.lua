...
L_OPT_BARS_MERGEBAR4ANDBAR5 = 'Merge right side actionbars'
...
L_OPT_COMMAND_HVB = 'Enable hover hotkey binding for actionbar button (not support for DarkUI extra buttons)'
...
L_OPT_COMMAND_RESTUI = 'Rest DarkUI'
