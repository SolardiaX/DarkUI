...
L_OPT_BAGS_SLOT_SIZE = "背包格子大小"
L_OPT_BAGS_ITEM_FILTER = "啟用物品分類"
L_OPT_BAGS_FILTER_EQUIPMENT = "過濾裝備"
L_OPT_BAGS_FILTER_CONSUMABLE = "過濾消耗品"
L_OPT_BAGS_FILTER_GOODS = "過濾商品材料"
L_OPT_BAGS_FILTER_QUEST = "過濾任務物品"
L_OPT_BAGS_FILTER_COLLECTION = "過濾收藏品"
L_OPT_BAGS_FILTER_JUNK = "過濾垃圾"
L_OPT_BAGS_FILTER_EQUIPSET = "過濾套裝集合"
L_OPT_BAGS_FILTER_AOE = "過濾戰團綁定裝備"
L_OPT_BAGS_FILTER_DECOR = "過濾裝飾品"
L_OPT_BAGS_FILTER_LEGACY = "過濾舊版本裝備"
...
L_OPT_MISC_AUTOMATION_AUTO_GREED = "滿級後綠色裝備 Roll 點時自動選擇貪婪"
L_OPT_MISC_AUTOMATION_AUTO_QUEST = "自動交接任務 (按住 SHIFT 點擊 NPC 可禁用)"
L_OPT_MISC_AUTOMATION_TAB_BINDER = "PVP 模式下優化目標選擇鍵只選中敵對玩家"
L_HEADER_ANNOUNCEMENT = "通報"
...
L_OPT_ANNOUNCEMENT_QUEST_NOTIFICATION = "任務進度通報"
