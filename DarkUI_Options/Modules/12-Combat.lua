...
addon.OptionList["combat"] = {
    ...
    {
        DROP,
        "combat.combatText.group_appearance",
        L_OPT_COMBATTEXT_GROUP_APPEARANCE,
        {
    ...
    {
        DROP,
        "combat.damageMeter.headerBgMode",
        L_OPT_DMETER_HEADER_BG or "Header background display",
        {
    ...
    {
        DROP,
        "combat.damageMeter.headerBtnMode",
        L_OPT_DMETER_HEADER_BTN or "Header elements display",
        {
    ...
    {
        DROP,
        "combat.damageMeter.win2Position",
        L_OPT_DMETER_WIN2_POS or "Window 2 position",
        {
    ...
    {
        DROP,
        "combat.damageMeter.win3Target",
        L_OPT_DMETER_WIN3_TARGET or "Window 3 target",
        {
    ...
    {
        DROP,
        "combat.damageMeter.win3Position",
        L_OPT_DMETER_WIN3_POS or "Window 3 position",
        {
            { L_OPT_DMETER_POS_TOP or "Top", "TOP" },
            { L_OPT_DMETER_POS_BOTTOM or "Bottom", "BOTTOM" },
            { L_OPT_DMETER_POS_LEFT or "Left", "LEFT" },
    ...
    {
        DROP,
        "combat.damageMeter.resetMode",
        L_OPT_DMETER_RESET_MODE or "Reset mode",
        {
