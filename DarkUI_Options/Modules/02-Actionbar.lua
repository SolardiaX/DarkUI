...
ns.OptionList[2] = { -- Actionbar
    { 1, 'actionbar', 'bars.enable', L_OPT_BARS_ENABLE, false, nil, function(self)
        self:HookScript('OnClick', function(self)
            ...
            --
            ns.opt_widgets['actionbar:bars.bar4.enable']:SetEnabled(self:GetChecked())
            ns.opt_widgets['actionbar:bars.bar5.enable']:SetEnabled(self:GetChecked())
            ns.opt_widgets['actionbar:bars.bar6.enable']:SetEnabled(self:GetChecked())
            ns.opt_widgets['actionbar:bars.mergeright']:SetEnabled(self:GetChecked())
            ns.opt_widgets['actionbar:bars.bar7.enable']:SetEnabled(self:GetChecked())
            ns.opt_widgets['actionbar:bars.bar8.enable']:SetEnabled(self:GetChecked())
            ns.opt_widgets['actionbar:bars.mergebottom']:SetEnabled(self:GetChecked())
            --
    ...
    {},
    { 1, 'actionbar', 'bars.bar4.enable', L_OPT_BARS_RIGHTBAR1_ENABLE, false, nil, function(self)
        self:HookScript('OnShow', function(self)
            self:SetEnabled(ns.opt_widgets['actionbar:bars.enable']:GetChecked())
        end)
        self:HookScript('OnClick', function(self)
            ns.opt_widgets['actionbar:bars.mergeright']:SetEnabled(
                ns.opt_widgets['actionbar:bars.enable']:GetChecked() 
                and (ns.opt_widgets['actionbar:bars.bar4.enable']:GetChecked() 
                    or ns.opt_widgets['actionbar:bars.bar5.enable']:GetChecked()
                    or ns.opt_widgets['actionbar:bars.bar6.enable']:GetChecked()
                )
            )
        end)
    end },
    { 1, 'actionbar', 'bars.bar5.enable', L_OPT_BARS_RIGHTBAR2_ENABLE, false, nil, function(self)
        self:HookScript('OnShow', function(self)
            self:SetEnabled(ns.opt_widgets['actionbar:bars.enable']:GetChecked())
        end)
        self:HookScript('OnClick', function(self)
    ...
    { 1, 'actionbar', 'bars.bar6.enable', L_OPT_BARS_RIGHTBAR3_ENABLE, false, nil, function(self)
        self:HookScript('OnShow', function(self)
            self:SetEnabled(ns.opt_widgets['actionbar:bars.enable']:GetChecked())
        end)
        self:HookScript('OnClick', function(self)
    ...
    { 1, 'actionbar', 'bars.bar7.enable', L_OPT_BARS_BOTTOMBAR1_ENABLE, false, nil, function(self)
        self:HookScript('OnShow', function(self)
            self:SetEnabled(ns.opt_widgets['actionbar:bars.enable']:GetChecked())
        end)
        self:HookScript('OnClick', function(self)
            ns.opt_widgets['actionbar:bars.mergebottom']:SetEnabled(
                ns.opt_widgets['actionbar:bars.enable']:GetChecked() 
                and (ns.opt_widgets['actionbar:bars.bar7.enable']:GetChecked() 
                    or ns.opt_widgets['actionbar:bars.bar8.enable']:GetChecked()
                )
            )
        end)
    end },
    { 1, 'actionbar', 'bars.bar8.enable', L_OPT_BARS_BOTTOMBAR2_ENABLE, false, nil, function(self)
        self:HookScript('OnShow', function(self)
            self:SetEnabled(ns.opt_widgets['actionbar:bars.enable']:GetChecked())
        end)
        self:HookScript('OnClick', function(self)
    ...
    { 1, 'actionbar', 'bars.mergebottom', L_OPT_BARS_MERGEBOTTOM, false, nil, function(self)
        self:HookScript('OnShow', function(self)
            self:SetEnabled(ns.opt_widgets['actionbar:bars.enable']:GetChecked() 
                                and (ns.opt_widgets['actionbar:bars.bar7.enable']:GetChecked() 
                                        or ns.opt_widgets['actionbar:bars.bar8.enable']:GetChecked()))
