...
----------------------------------------------------------------------------------------
-- Raid Frame Corner Buffs & Major Spells
----------------------------------------------------------------------------------------

E.RaidDebuffs = {}

function E:RegisterRaidDebuff(tier, instID, bossID, spellID, level)
    if not E.RaidDebuffs[instID] then
        E.RaidDebuffs[instID] = {}
    end
    E.RaidDebuffs[instID][spellID] = level or 2
end

function E:RegisterSeasonSpells(tier, instID)
    if not E.RaidDebuffs[instID] then
        E.RaidDebuffs[instID] = {}
    end
end
...
E.CornerBuffs = {
    ...
    ["SHAMAN"] = {
        ...
        [383648] = { "BOTTOMRIGHT", { 1, 0.8, 0 } }, -- 大地之盾
    },
    ["MONK"] = {
...
function E:RegisterSeasonSpells(tier, instance)
    for spellID, priority in pairs(SEASON_SPELLS) do
        E:RegisterRaidDebuff(tier, instance, 0, spellID, priority)
    end
end
