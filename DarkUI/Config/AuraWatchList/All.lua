...
----------------------------------------------------------------------------------------
-- AuraWatch Spell List (All Classes)
----------------------------------------------------------------------------------------

E.AuraWatchList = E.AuraWatchList or {}
E.AuraWatchList["ALL"] = {
    ...
    ["Enchant Aura"] = { -- 附魔及饰品组
        ...
        { AuraID = 1213433, UnitID = "player", Text = "Crit" }, -- 哈哈棱镜
        { AuraID = 1213434, UnitID = "player", Text = "Haste" }, -- 哈哈棱镜
        ...
        { AuraID = 381954, UnitID = "player", Text = "Crit" }, -- 奈萨鲁斯战利品
        { AuraID = 381955, UnitID = "player", Text = "Haste" }, -- 奈萨鲁斯战利品
        { AuraID = 381956, UnitID = "player", Text = "Mastery" }, -- 奈萨鲁斯战利品
        { AuraID = 381957, UnitID = "player", Text = "Versa" }, -- 奈萨鲁斯战利品
        ...
        { AuraID = 354053, UnitID = "player", Flash = true, Text = "Crit" }, -- 致命缺陷，暴击
        { AuraID = 354054, UnitID = "player", Flash = true, Text = "Versa" }, -- 致命缺陷，全能
    ...
    ["Raid Debuff"] = { -- 团队减益组
        ...
        { AuraID = 268086, UnitID = "player", Text = "Move" }, -- 恐怖光环，庄园
