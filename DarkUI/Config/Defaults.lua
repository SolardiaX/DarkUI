...
----------------------------------------------------------------------------------------
--  Default Configuration (registered with Database system)
--  Values defined here are read-only defaults. User overrides are stored separately
--  in SavedVariables and merged at runtime via E.db:BuildProxy() into the C table.
----------------------------------------------------------------------------------------
...
defaults.actionbar = {
    bars = {
        ...
        micromenu = {
            ...
            scale = 1,
            fader_mouseover = { fadeIn = { time = 0.4, alpha = 1 }, fadeOut = { time = 0.3, alpha = 0 } },
        },
        bags = {
            enable = true,
...
----------------------------------------------------------------------------------------
E.db:RegisterDefaults(defaults)
