...
local ConvertRGBtoColorString, GetQuestDifficultyColor = ConvertRGBtoColorString, GetQuestDifficultyColor
local ChatFrame_AddMessageEventFilter = ChatFrame_AddMessageEventFilter
local ChatFrame_MessageEventHandler = ChatFrame_MessageEventHandler
local gsub, gmatch, unpack, tinsert = gsub, gmatch, unpack, tinsert
