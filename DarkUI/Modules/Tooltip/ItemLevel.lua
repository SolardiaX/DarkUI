...
local GetCVar, GetTime = GetCVar, GetTime
...
local UnitExists, UnitClass, UnitGUID, UnitIsPlayer, UnitLevel = UnitExists, UnitClass, UnitGUID, UnitIsPlayer, UnitLevel
local UnitSex = UnitSex
local strsplit, strmatch, tinsert, wipe, format = strsplit, strmatch, tinsert, wipe, format
local hooksecurefunc =hooksecurefunc
local ITEM_LEVEL, ITEM_LEVEL_ALT = ITEM_LEVEL, ITEM_LEVEL_ALT
local QUEUED_STATUS_WAITING, SEARCH, FAILED = QUEUED_STATUS_WAITING, SEARCH, FAILED
...
function eve:INSPECT_READY(guid)
    ActiveGUID = nil
...
function eve:ADDON_LOADED(addon)
    if addon == "Blizzard_InspectUI" then
        InspectLevel()
    end
end

function eve:ItemScanComplete(guid)
