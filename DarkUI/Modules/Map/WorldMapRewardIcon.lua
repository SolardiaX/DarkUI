...
function DarkUIWorldQuestPinMixin:AddIconWidgets()
end
...
local function setupWorldQuestProvider()
	...
	provider.GetPinTemplate = function()
		return "DarkUIWorldQuestPinTemplate"
	end

	provider.ShouldOverrideShowQuest = function()
	end
	...
	provider.ShouldShowQuest = function(self, questInfo)
		...
		if originalShouldShowQuest(self, questInfo) then
			return true
		end
...
local function setupPOIProvider()
	...
	function provider:GetPinTemplate()
		return "DarkUIWorldQuestPOITemplate"
	end
...
local function setupEventProvider()
	...
	function provider:GetPinTemplate()
		return "DarkUIWorldQuestEventTemplate"
	end
...
function module:OnInit()
	...
	if C_AddOns.IsAddOnLoaded("BetterWorldQuests") then
		return
	end
