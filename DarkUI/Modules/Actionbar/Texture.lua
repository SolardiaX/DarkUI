...
local BarBottomLeftBG = CreateFrame("Frame", "DarkUI_ActionBar2HolderBG", _G["MultiBarBottomLeft"])
...
local BarBottomRightBG = CreateFrame("Frame", "DarkUI_ActionBar3HolderBG", _G["MultiBarBottomRight"])
