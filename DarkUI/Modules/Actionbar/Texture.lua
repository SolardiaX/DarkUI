...
----------------------------------------------------------------------------------------
local module = M:Module("Actionbar"):Sub("Texture")
...
if C.general.liteMode then
    BarBottomLeftBG:SetPoint("BOTTOM", _G["DarkUI_ActionBar2"], 4, -128)
else
    BarBottomLeftBG:SetPoint("BOTTOM", _G["DarkUI_ActionBar2"], 2, -127)
end
...
if C.general.liteMode then
    ...
    BarBottomRightBG:SetPoint("BOTTOM", _G["DarkUI_ActionBar3"], 4, -49)
else
    BarBottomRightBG:SetPoint("BOTTOM", _G["DarkUI_ActionBar3"], 4, -49)
end
