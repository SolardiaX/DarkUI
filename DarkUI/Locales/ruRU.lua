...
L.ACTIONBAR_BINDING_MODETEXT =
    "Наведите курсор на любую кнопку действия для привязки. Нажмите Escape или щелкните правой кнопкой мыши, чтобы очистить текущую привязку кнопки действия"
