...
-- Ported from ElvUI Mainline/Skins/WeeklyRewards.lua (v15.15, 2026-06)
------------------------------------------------------------------------
...
local function SkinRewardIcon(itemFrame)
    if not itemFrame.__styled then
...
local function SkinActivityFrame(frame, isObject)
    ...
    if isObject then
        ...
        elseif frame.UnselectedFrame and C.skins.parchment_remover then -- the button
