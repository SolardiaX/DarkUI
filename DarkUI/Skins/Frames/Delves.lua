...
------------------------------------------------------------------------
-- Delves UI
-- Ported from ElvUI Mainline/Skins/Delves.lua (v15.15, 2026-06)
------------------------------------------------------------------------
...
local function HandleButton(button)
    ...
    if button.Icon then S:HandleIcon(button.Icon) end

    button.__styled = true
end

local function UpdateButton(self) self:ForEachFrame(HandleButton) end
...
local function DifficultyPickerFrame_Update(frame) frame:ForEachFrame(SetRewards) end
